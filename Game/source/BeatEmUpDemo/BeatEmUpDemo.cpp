...
void BeatEmUpDemo::Init()
{
	...
	Engine::GetCameraManager().GetCamera()->SetFar(91.f);
	Engine::GetCameraManager().GetCamera()->SetBaseFov(45.f);
	Engine::GetCameraManager().GetCamera()->SetCameraPosition({ 0.f,10.f, 30.f });
	Engine::GetCameraManager().GetCamera()->UpdateCameraDirection({ 0.f, 10.f });
	...
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("road");
	...
	Engine::GetObjectManager().GetLastObject()->SetXRotate(90.f);
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("road1");
	...
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("3");

	Engine::GetObjectManager().AddObject<Object>(glm::vec3{ 7.5f, 5.f,-38.f }, glm::vec3{ 22.f, 16.f,0.f }, "1");
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("1");

	Engine::GetObjectManager().AddObject<Object>(glm::vec3{ 29.5f, 5.f,-38.f }, glm::vec3{ 22.f, 16.f,0.f }, "2");
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("2");
	...
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("4");
	...
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("4_2");

	Engine::GetObjectManager().AddObject<Object>(glm::vec3{ -5.f, -3.f,-50.5f }, glm::vec3{ 3.f, 13.5f,0.f }, "road");
	Engine::GetObjectManager().GetLastObject()->SetXRotate(90.f);
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("4_1");
...
void BeatEmUpDemo::Update(float dt)
{
	...
	{
		Engine::GetCameraManager().GetCamera()->MoveCameraPos(CameraMoveDir::FOWARD, 10.f * dt);
	}
	if (Engine::GetInputSnapshot().IsKeyPressed(KEYBOARDKEYS::S))
	{
		Engine::GetCameraManager().GetCamera()->MoveCameraPos(CameraMoveDir::BACKWARD, 10.f * dt);
	}
	if (Engine::GetInputSnapshot().IsKeyPressed(KEYBOARDKEYS::A))
	{
		Engine::GetCameraManager().GetCamera()->MoveCameraPos(CameraMoveDir::LEFT, 10.f * dt);
	}
	if (Engine::GetInputSnapshot().IsKeyPressed(KEYBOARDKEYS::D))
	{
		Engine::GetCameraManager().GetCamera()->MoveCameraPos(CameraMoveDir::RIGHT, 10.f * dt);
	}
