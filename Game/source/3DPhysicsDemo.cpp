...
void PhysicsDemo::Init()
{
	...
	//Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddMesh3D(MeshType::OBJ, "../Game/assets/Models/sphere.obj", 1, 1, { 0.8f, 0.8f, 0.8f, 1.0f });
	...
	//Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	//Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddMesh3D(MeshType::OBJ, "../Game/assets/Models/sphere.obj", 1, 1, { 0.0, 0.0, 1.0, 1.0 });
	//Engine::GetObjectManager().GetLastObject()->AddComponent<Physics3D>();
	...
	Engine::GetObjectManager().GetLastObject()->GetComponent<Light>()->AddLight(LightType::POINT, 100.f);
