...
void VerticesDemo::Init()
{
	...
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->LoadAnimation("../Game/assets/PlatformDemo/player.spt", "Player");
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->PlayAnimation(1);
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->SetSpriteDrawType(SpriteDrawType::UI);
	...
	Engine::GetObjectManager().GetLastObject()->AddComponent<DynamicSprite>();
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->AddQuadWithTexture("FPS");
	Engine::GetObjectManager().GetLastObject()->GetComponent<DynamicSprite>()->SetSpriteDrawType(SpriteDrawType::UI);
}
