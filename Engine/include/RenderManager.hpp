...
private:
	...
	// Mesh Quantization
	// https://github.com/tsherif/mesh-quantization-example
	...
	glm::mat4 Quantize(std::vector<ThreeDimension::Vertex>& vertices, std::vector<ThreeDimension::QuantizedVertex>& quantizedVertices);
};
