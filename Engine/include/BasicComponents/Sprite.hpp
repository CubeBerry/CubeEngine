...
public:
	...
	glm::vec3 GetSpecularColor(int index = 0) { return subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.specularColor; }
	float GetShininess(int index = 0) { return subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.shininess; }
	float GetMetallic(int index = 0) { return subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.metallic; }
	float GetRoughness(int index = 0) { return subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.roughness; }
	// Buffer
	...
	void SetSpecularColor(glm::vec3 sColor, int index = 0) { subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.specularColor = sColor; }
	void SetShininess(float amount, int index = 0) { subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.shininess = amount; }
	void SetMetallic(float amount, int index = 0) { subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.metallic = amount; }
	void SetRoughness(float amount, int index = 0) { subMeshes[index]->GetClassifiedData<BufferWrapper::BufferData3D>().material.roughness = amount; }
