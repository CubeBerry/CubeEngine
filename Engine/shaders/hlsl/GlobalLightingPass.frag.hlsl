...
#line 159 "slang/GlobalLightingPass.slang"
...
#line 332
    return float4(((1.0f - metallic_0) * ((float3)1.0f - F_1) * (irradianceMap_0.Sample(iblSmp_0, N_5).xyz * albedo_2) + prefilterMap_0.SampleLevel(iblSmp_0, reflect(- V_5, N_5), roughness_2 * 4.0f).xyz * (F_1 * brdf_0.x + brdf_0.y)) * SSAO_0.Sample(gSampler_0, _S7.uv_0).x + resultColor_0, 1.0f);
}
