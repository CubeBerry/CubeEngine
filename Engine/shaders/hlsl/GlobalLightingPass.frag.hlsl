...
#line 66 "slang/GlobalLightingPass.slang"
...
#line 160 "slang/GlobalLightingPass.slang"
...
#line 297
    ...
    float3 Kd_0 = (1.0f - metallic_0) * ((float3)1.0f - F_1);

#line 306
    float3 diffuse_0 = irradianceMap_0.Sample(iblSmp_0, N_5).xyz * albedo_2;

#line 311
    float2 brdf_0 = brdfLUT_0.Sample(iblSmp_0, float2(max(dot(N_5, V_5), 0.0f), roughness_2)).xy;

#line 316
    float3 specular_0 = prefilterMap_0.SampleLevel(iblSmp_0, reflect(- V_5, N_5), roughness_2 * 4.0f).xyz * (F_1 * brdf_0.x + brdf_0.y);

#line 316
    float ao_0;


    if((pushConstants_0.useSSAO_0) > int(0))
    {

#line 319
        ao_0 = SSAO_0.Sample(gSampler_0, _S7.uv_0).x;
...
#line 334
    return float4((Kd_0 * diffuse_0 + specular_0) * ao_0 + resultColor_0, 1.0f);
}
